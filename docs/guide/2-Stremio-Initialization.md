...
# ⚙️ 2. Cài đặt ban đầu cho tài khoản Stremio


Tiếp theo, chúng ta hãy cùng chuẩn bị tài khoản Stremio sao cho "sạch sẽ" và đúng chuẩn nhất:

1. **<mark>Đăng nhập vào Stremio Web:</mark>** Mở [**Stremio Web**](https://web.stremio.com) và đăng nhập vào tài khoản của mình.
   ...
   * Bạn cần sử dụng trình duyệt web trên máy tính hoặc điện thoại để thực hiện các bước cấu hình.
...
2. **<mark>Dọn dẹp Addon:</mark>** Vào mục **<mark2>Addons</mark2>** và gỡ cài đặt (uninstall) **<mark2>TẤT CẢ</mark2>** các addon sẵn có.
   * *Gỡ bỏ cả addon **<mark2>Trakt Integration,</mark2>** nó hoàn toàn khác với tính năng **<mark2>Trakt Scrobbling</mark2>** vừa bật ở bước trên. Chúng ta không cần addon này vì sẽ sử dụng một giải pháp khác tối ưu hơn.*
...
3. **<mark>Kích hoạt đồng bộ Trakt:</mark>** *Bỏ qua bước này nếu không có nhu cầu sử dụng*
   ...
   * *Bước này giúp Stremio tự động gửi lịch sử và tiến trình xem phim của bạn lên Trakt để lưu trữ.*
